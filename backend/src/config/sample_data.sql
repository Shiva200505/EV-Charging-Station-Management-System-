...
('Eco-Station Alpha', 'Shivaji Nagar', 12, 8, 'DC Fast', '150kW', 13.75, 'active'),
('Green Power Hub', 'Hadapsar', 8, 6, 'AC Level 2', '22kW', 8.95, 'active'),
('Rapid Charge Zone', 'Wakad', 10, 3, 'DC Fast', '100kW', 12.99, 'active'),
('ElectroCharge Point', 'Kalyani Nagar', 6, 4, 'AC Level 2', '22kW', 9.50, 'active'),
('Future Energy Station', 'Yerawada', 14, 7, 'DC Fast', '200kW', 15.25, 'active'),
('Smart Charge Hub', 'PCMC', 10, 0, 'DC Fast', '150kW', 13.50, 'maintenance'),
('EcoVolt Station', 'Sinhagad Road', 8, 5, 'AC Level 2', '22kW', 8.75, 'active'),
('PowerMax Center', 'Wagholi', 12, 9, 'DC Fast', '350kW', 17.80, 'active'),
('GreenTech Charging', 'Pimpri', 10, 6, 'DC Fast', '100kW', 12.25, 'active'); 